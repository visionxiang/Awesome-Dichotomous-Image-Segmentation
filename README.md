...
| **Year** | **Pub.** | **Model** | **Title**          | **Links**        |
| :------: | :------: | :------: |:----------------------------------------------------------- |  :----------------------------------------------------------- |
| 2024    | arXiv     | <sup>`RMFormer`</sup> | PGNeXt: High-Resolution Salient Object Detection via Pyramid Grafting Network   <br> <sup><sub>*Changqun Xia, Chenxi Xie, Zhentao He, Tianshu Yu, Jia Li*</sub></sup>  | [Paper](https://www.arxiv.org/abs/2408.01137)\|Code
